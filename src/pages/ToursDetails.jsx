...
const ToursDetails = () => { 
    ...
    const {totalRating, avgRating} = caculateAvgRating
    (reviews)
                        ...
                        <div className="tour__content">
                            ...
                            <div className="tour__info">
                                ...
                                <div className="tour__extra-details">
                                       ...
                                       <span> 
                                        <i class="ri-group-line"></i> {maxGroupsize} 8 people
                                       </span>
                                </div>
                            ...
                            <div className="tour__reviews mt-4">
                                ...
                                <Form onSubmit={submitHandler}>
                                    <div className="rating__group d-flex align-items-center 
                                    gap-3 mb-4">
